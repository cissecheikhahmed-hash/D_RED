  ...
  return (
    <svg viewBox="0 0 100 120" className={className} fill="none" aria-hidden="true">
      <path
        ...
        fill="white"
      />
      <ellipse cx="38" cy="82" rx="9" ry="15" fill="#A50606" opacity="0.16" />
    </svg>
  );
}
...
export function AlerteIllustration({ className }: IllustrationProps) {
  return (
    <svg viewBox="0 0 120 120" className={className} aria-hidden="true">
      <circle cx="60" cy="60" r="60" fill="#F8EFD7" />
      <circle cx="82" cy="40" r="20" fill="none" stroke="#A50606" strokeWidth="2" opacity="0.35" />
      <circle cx="82" cy="40" r="13" fill="none" stroke="#A50606" strokeWidth="2" opacity="0.55" />
      <rect x="38" y="30" width="34" height="58" rx="7" fill="white" stroke="#0B0B0D" strokeWidth="2" />
      <rect x="44" y="38" width="22" height="34" rx="2" fill="#F8EFD7" />
      <circle cx="55" cy="80" r="3" fill="#0B0B0D" />
      <path
...
export function DisponibiliteIllustration({ className }: IllustrationProps) {
  return (
    <svg viewBox="0 0 120 120" className={className} aria-hidden="true">
      ...
      <rect x="34" y="92" width="52" height="20" rx="10" fill="white" stroke="#0B0B0D" strokeWidth="2" />
      <circle cx="72" cy="102" r="7" fill="#A50606" />
    </svg>
  );
}
...
export function VerifieIllustration({ className }: IllustrationProps) {
  return (
    <svg viewBox="0 0 120 120" className={className} aria-hidden="true">
      <circle cx="60" cy="60" r="60" fill="#F8EFD7" />
      <circle cx="30" cy="40" r="5" fill="#A50606" opacity="0.4" />
      <circle cx="92" cy="46" r="4" fill="#A50606" opacity="0.4" />
      <circle cx="88" cy="86" r="5" fill="#A50606" opacity="0.4" />
      <path
...
export function GuidageIllustration({ className }: IllustrationProps) {
  return (
    <svg viewBox="0 0 320 180" className={className} aria-hidden="true">
      <rect x="0" y="0" width="320" height="180" fill="#F8EFD7" />
      <g opacity="0.5" fill="#0B0B0D">
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="20" cy="150" r="7" fill="#0B0B0D" />
      <path
...
export function CelebrationIllustration({ className }: IllustrationProps) {
  return (
    <svg viewBox="0 0 120 120" className={className} aria-hidden="true">
      <circle cx="60" cy="60" r="60" fill="#F8EFD7" />
      <rect x="24" y="24" width="8" height="8" rx="2" fill="#A50606" opacity="0.5" transform="rotate(18 28 28)" />
      <rect x="88" y="30" width="7" height="7" rx="2" fill="#1F9D55" opacity="0.6" transform="rotate(-12 91 33)" />
      <circle cx="30" cy="88" r="4" fill="#E8912D" opacity="0.7" />
      <circle cx="94" cy="82" r="5" fill="#A50606" opacity="0.4" />
      <path
